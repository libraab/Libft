...
SRC=ft_putchar.c ft_putstr.c ft_strcmp.c ft_strlen.c ft_atoi.c ft_memset.c \
	...
	ft_strdup.c ft_strncmp.c ft_strnstr.c ft_strcpy.c ft_strlcpy.c\
	ft_strncpy.c ft_strcat.c ft_strncat.c ft_strlcat.c ft_strchr.c ft_split.c \
...
BONUS =	ft_lstnew.c ft_lstadd_front.c ft_lstadd_back.c ft_lstdelone.c \
		ft_lstclear.c ft_lstiter.c ft_lstmap.c ft_lstsize.c \
